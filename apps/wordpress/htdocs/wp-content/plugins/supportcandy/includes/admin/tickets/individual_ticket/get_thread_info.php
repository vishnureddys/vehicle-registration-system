...
$agent_created = $wpscfunction->get_ticket_fields($ticket_id,'agent_created');
$agent_created = $agent_created ? __('Yes','supportcandy') : __('No','supportcandy');
...
<div id="wpsc_raised_extra_info">
	<table class="table table-hover">
		...
		if($source == 'raised_by'){?>
			<tr>
				<td><strong><?php _e('Agent Created','supportcandy'); ?></strong></td>
				<td><?php echo $agent_created; ?></td>
			</tr><?php
		}?>
