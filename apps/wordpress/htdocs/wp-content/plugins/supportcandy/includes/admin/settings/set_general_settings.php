...
//allow create ticket
$wpsc_allow_to_create_ticket = isset($_POST) && isset($_POST['wpsc_allow_to_create_ticket']) && is_array($_POST['wpsc_allow_to_create_ticket']) ? $_POST['wpsc_allow_to_create_ticket'] : array();
update_option('wpsc_allow_to_create_ticket',$wpsc_allow_to_create_ticket);
