...
foreach ($email_templates as $email) :
  ...
  if( $wpscfunction->check_ticket_conditions($conditions,$ticket_id) ) :
    ...
    $to = apply_filters('wpsc_change_status_to_email',$to,$email_addresses,$ticket_id);
    $bcc = apply_filters('wpsc_change_status_bcc_emails',$bcc,$email_addresses,$ticket_id);
